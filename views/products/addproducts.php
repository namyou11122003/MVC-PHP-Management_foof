...
<form method="post" enctype="multipart/form-data">
    <label for="product_id" hidden>ID</label>
    <input type="text" readonly class="form-control" hidden name="product_id">
    ...
    <select name="category_no" class="form-control" id="category_no" required>
        ...
        <option value="Fried Chicken">Healthy Food</option>
    </select>
...
if (isset($_POST['save_product'])) {
    ...
    if ($_FILES['product_image']['error'] !== UPLOAD_ERR_OK) {
        ...
        if (!in_array($imageExtension, $validImageExtension)) {
            ...
            move_uploaded_file($tmpname, 'products/' . $image);
